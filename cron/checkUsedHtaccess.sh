...
function phase1 {
    ...
    while [ ${ENDLOOP} = false ]; do
        case ${CMD} in
            1) line1='RewriteCond %{HTTP_HOST} ^dev.oemusedequipment.com$' || errorExit $CMD $LINENO "Could not set line 1 variable"
